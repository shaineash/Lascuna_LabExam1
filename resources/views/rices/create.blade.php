                ...
                <form action="{{ route('rices.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" 
                               id="name" name="name" placeholder="e.g., Jasmine, Brown Rice, Dinorado" 
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error('price_per_kg') is-invalid @enderror" 
                                   id="price_per_kg" name="price_per_kg" placeholder="0.00" 
                                   step="0.01" value="{{ old('price_per_kg') }}" required>
                        </div>
                        @error('price_per_kg')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  ...
                                  placeholder="Enter rice description...">{{ old('description') }}</textarea>
                        @error('description')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-custom text-white">Add Rice</button>
                    </div>
                </form>
            </div>
        </div>
